...
public class CourseController {
    ...
    public String courses(Model model) {
        ...
        List<Course> sortedList = Lists.newArrayList(courseService.courses());
    ...
    public String courseview(@PathVariable Integer id, Model model) throws IOException {
    ...
    public String coursemodify(@PathVariable Integer id, Model model) throws IOException{
        Course course = courseService.courseDetails(id);
        model.addAttribute("course", course);
        return "coursenew";
    }
